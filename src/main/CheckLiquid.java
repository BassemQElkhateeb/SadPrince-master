...
public class CheckLiquid {
    GamePanel gamePanel;

    public CheckLiquid(GamePanel gamePanel) {
    ...
    public void checkTile(Entity entity){
        ...
        switch (entity.direction) {
            case "up" -> {
                ...
                if (gamePanel.tileManager.tiles[tileNum1].liquid == true ||
                        gamePanel.tileManager.tiles[tileNum2].liquid == true) {
